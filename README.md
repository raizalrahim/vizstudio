...
| **Ring Burst** | Concentric rings that expand outward on energy peaks then fade — dramatic on bass-heavy music |
...
Oscilloscope → Lissajous → Bars → Wave → Mirror Bars → Ring Burst → Blob → Spectrum Fill → Radial Bars → Circle
