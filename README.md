...
| Viz type | Playback position |
| Colors (1 & 2) | |
| Sensitivity | |
| Custom labels | |
| Stem filenames (as hints) | |

> **Why audio files aren't saved:** Browsers deliberately block JavaScript from storing or re-accessing local files between sessions for security reasons. This applies to both the main track and stem files. After loading a layout, simply re-upload your audio files manually — the panel setup is already done for you.
